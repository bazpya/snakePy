...
class Worm_events_(Worm_):
    def test_step_when_into_blank_emits_the_right_eventsz(self):
    ...
    def test_step_when_into_wall_emits_the_right_eventsz(self):
    ...
    def test_step_when_into_worm_emits_the_right_eventsz(self):
    ...
    def test_step_when_into_food_emits_the_right_eventsz(self):
